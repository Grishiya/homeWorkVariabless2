public class Main {
    ...
    public static void task8() {
        ...
        //упустил момент с обязательным умножением.
        double pMasha = zpMasha * 0.1;
        double pDenis = zpDenis * 0.1;
        double pKristina = zpKristina * 0.1;
        //присваиваю целочисленному числу вещественное,или наоборот :)
        int zpMashaUp2 = zpMasha + (int) (pMasha);
        int zpDenisUp2 = zpDenis + (int) (pDenis);
        int zpKristinaUp2 = zpKristina + (int) (pKristina);
        //Проверяю вычисления
        System.out.println(zpMashaUp2);
        System.out.println(zpDenisUp2);
        System.out.println(zpKristinaUp2);
        //Вычесления верны.
